...
public class Painting extends View {
    ...
    public int DEFAULT_COLOR = Color.LTGRAY;
    ...
    public void changeColorToBlack() { currentColor = Color.BLACK; }
    ...
    public void changeColorToDarkGreen() { currentColor = Color.rgb(16,81,0); }
